...
4. **`output/html/ch1_1_components.html`**（⭐ 架构设计与参考流程必读）
   - **1.1.1 ~ 1.1.3**：理解 IOS 六大工作区的关注点分离、领域建模、认知心理学逻辑与 UI 控件体系。
   - **1.1.4 ~ 1.1.14**：理解 6 个参考流程（RF-01 ~ RF-06）的端到端路径、跨工作区数据流、状态一致性约束与边界降级行为。
...
|------|-------------|-------------|------|
| 1.1 | 组成部分（含参考流程） | ## 3.1 IOS Workspaces + ## 3.2 UI Controls + 1.1~1.7 流程整合 | ✅ V2.0 已完成（合并 ch1_8 全部参考流程与架构分析） |
