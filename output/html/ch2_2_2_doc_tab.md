...
| **缩略图/列表区** Thumbnail / List Panel | 左侧边栏 | 以缩略图或列表形式展示文档所有页面，点击切换页面；两种视图互斥显示 |
| **视图切换** Thumbnail / List Toggle | 顶部工具栏（最左侧） | 缩略图视图按钮 / 列表视图按钮，切换左侧边栏显示模式 |
...
- 缩略图视图和列表视图是**互斥状态**，同一时间只能显示一种
- 切换视图不会丢失当前选中的页面位置
- 切换后，当前高亮/选中的页面在另一种视图中保持选中状态

### 3.4 上下滚动（Scroll Up and Down）
